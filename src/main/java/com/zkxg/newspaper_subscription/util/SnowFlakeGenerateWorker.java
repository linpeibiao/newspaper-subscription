package com.zkxg.newspaper_subscription.util;

import org.apache.commons.lang3.builder.ToStringExclude;

/**
 * @author xiaohu
 * @date 2022/10/15/ 14:55
 * @description 雪花算法id生成工具类
 */
public class SnowFlakeGenerateWorker {
    /**
     * 开始时间截
     */
    ...
    public SnowFlakeGenerateWorker(long workerId, long datacenterId) {
